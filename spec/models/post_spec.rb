...
RSpec.describe Post, type: :model do
    ...
    it 'comments_couter should be equal to 2' do
        first_comment = Comment.create(post: subject, author: user, text: 'First comment')
        second_comment = Comment.create(post: subject, author: user, text: 'Second comment')
    ...
    it 'likes_counter should be equal to 2' do
        first_like = Like.create(user: user, post: subject)
        second_like = Like.create(user: user_two, post: subject)
